...
```bash
-Xms700m -Xmx700m -XX:MaxPermSize=700m -Xdebug -XX:+HeapDumpOnOutOfMemoryError -XX:HeapDumpPath="C:\Users\li_wjie\Desktop"
```
...
```bash
-Xms700m -Xmx700m -XX:MaxPermSize=700m -Xdebug -Dcom.sun.management.jmxremote.ssl=false -Dcom.sun.management.jmxremote.authenticate=false -Djava.rmi.server.hostname=0.0.0.0 -Dcom.sun.management.jmxremote.port=9999 -XX:+HeapDumpOnOutOfMemoryError -XX:HeapDumpPath="C:\Users\li_wjie\Desktop"
```
...
```bash
-Xms768m -Xmx768m -XX:MaxPermSize=128m -Xdebug -Dcom.sun.management.jmxremote.ssl=false -Dcom.sun.management.jmxremote.authenticate=false -Djava.rmi.server.hostname=0.0.0.0 -Dcom.sun.management.jmxremote.port=9999 -Xloggc:"C:\Users\li_wjie\Desktop\gclog.log" -XX:+HeapDumpOnOutOfMemoryError -XX:HeapDumpPath="C:\Users\li_wjie\Desktop"
```
